    ...
    predefined.insert(
        ...
        quote! {
            ...
            fn peek<'i>(
                ...
                let string = state.stack.peek().expect("peek was called on empty stack").as_str();
